...
[![Codecov test coverage](https://codecov.io/gh/SvenKlaassen/AdaptiveDiscreteSmoothing/branch/master/graph/badge.svg)](https://codecov.io/gh/SvenKlaassen/AdaptiveDiscreteSmoothing?branch=master)
...
You can install the released version of AdaptiveDiscreteSmoothing from [CRAN](https://CRAN.R-project.org) with:
